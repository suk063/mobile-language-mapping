...
from lang_mapping.agent.agent_static_global_cnn import Agent_static_global_cnn
...
def train(cfg: TrainConfig):
    ...
    for name, param in agent.clip_model.transformer.named_parameters():
