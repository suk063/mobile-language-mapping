...
TASK_PLAN_IDX=${TASK_PLAN_IDX:-"-1"}
INIT_CONFIG_IDX=${INIT_CONFIG_IDX:-"-1"}
SPAWN_SELECTION_IDX=${SPAWN_SELECTION_IDX:-"-1"}
...
OUTPUT_FILE="${HOME}/Data/mobile_language_mapping_demo/${TASK}/${SUBTASK}/${OBJ}_static.pt"
...
args=(
    ...
    "fixed_task_plan_idx=${TASK_PLAN_IDX}"
    "fixed_init_config_idx=${INIT_CONFIG_IDX}"
    "fixed_spawn_selection_idx=${SPAWN_SELECTION_IDX}"
    "visualize=False"
