...
OUTPUT_DIR=/home/daizhirui/results/mobile_language_mapping/static_mapping_per_episode
export PYTHONPATH=${SCRIPT_DIR}/..

set -e
set -x

#python ${SCRIPT_DIR}/train_static_map_per_episode.py ${SCRIPT_DIR}/train_config_per_episode.yaml \
